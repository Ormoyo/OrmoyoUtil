 ...
 * @author Choonster
 */
public class PlayerDataProvider<HANDLER> implements ICapabilitySerializable<NBTBase> {
	/**
	 ...
	 */
	public PlayerDataProvider(Capability<HANDLER> capability, @Nullable EnumFacing facing) {
	 ...
	 */
	public PlayerDataProvider(Capability<HANDLER> capability, @Nullable EnumFacing facing, HANDLER instance) {
	...
	public <T> T getCapability(Capability<T> capability, EnumFacing facing) {
		if (capability == CapabilityHandler.CAPABILITY_PLAYER_DATA) {
			return CapabilityHandler.CAPABILITY_PLAYER_DATA.cast((IPlayerData) getInstance());
		}
